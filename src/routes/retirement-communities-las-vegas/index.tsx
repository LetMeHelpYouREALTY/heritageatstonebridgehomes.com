        ...
        <div class="max-w-7xl mx-auto px-4">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              ...
              <a href="/sun-city-del-webb-real-estate" class="text-orange-600 hover:text-orange-800 font-semibold">View Sun City Summerlin →</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              ...
              <a href="/luxury-homes" class="text-orange-600 hover:text-orange-800 font-semibold">View Siena →</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              ...
              <a href="/golf-course-homes" class="text-orange-600 hover:text-orange-800 font-semibold">View Country Club →</a>
            </div>
          </div>
        </div>
      </section>
