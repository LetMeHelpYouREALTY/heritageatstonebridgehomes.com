...
const HEADING_RULES: Array<{ test: RegExp; id: string }> = [
  ...
  { test: /the martin|citycenter|signature at mgm|mandarin oriental|\bwynn\b|bellagio/i, id: "las-vegas-strip-skyline" },
  { test: /turnberry/i, id: "55-plus-condos" },
  { test: /historic downtown|eldorado valley|sunrise hills|desert hills|lake mead|historic charm|small town/i, id: "boulder-city-homes" },
  { test: /upcoming development|coming soon|pre-construction/i, id: "new-construction-home" },
  { test: /sun city resale/i, id: "sun-city-summerlin" },
  ...
  { test: /clubhouse|social club|mature amenit|library|game room/i, id: "clubhouse" },
  ...
  { test: /gated|guard|\bsecurity\b/i, id: "gated-entrance" },
  { test: /maintenance-free/i, id: "clubhouse" },
  { test: /like-minded|social scene/i, id: "55-plus-community-lifestyle" },
  { test: /prime location|convenient access|easy access|convenient location/i, id: "downtown-summerlin" },
  ...
  { test: /55\+|active adult/i, id: "55-plus-community-lifestyle" },
  { test: /\bcall\b|\bemail\b|\bhours\b|get in touch/i, id: "contact-office" },
  { test: /investment|great value|growth potential/i, id: "las-vegas-market" },
