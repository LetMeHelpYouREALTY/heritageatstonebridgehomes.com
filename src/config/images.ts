...
const HEADING_RULES: Array<{ test: RegExp; id: string }> = [
  ...
  { test: /golf|fairway|anthem/i, id: "golf-course" },
  ...
  { test: /red rock|mountain|view|ridges/i, id: "red-rock-canyon" },
  ...
  { test: /henderson|inspirada|seven hills|macdonald/i, id: "henderson-community" },
